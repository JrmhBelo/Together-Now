...
--Falta o atributo genero M or F ☺ 
--------------
...
INSERT INTO public.evento(
	eve_nome, eve_descricao, eve_beneficiario, eve_datai, eve_dataf, eve_horai, eve_horaf, eve_morada, eve_maxparticipantes, eve_lati, eve_lon, eve_categ)
	VALUES ('Recolha de alimentos', 'Evento solidário', 'Blue Clapper', '2022-1-4', '2022-1-4', '10:00', '20:30', 'Pingo Doce São João do Estoril, R. Egas Moniz 173, 2765-478 Estoril', 6, 38.70059010524026, -9.38040829850534, 'Interior'); 
...
INSERT INTO public.regista(
	...
	VALUES ('2021-12-11', null, null, 'Cascais', 'Gosto de ajudar a comunidade por não?', null, 'Empregado', 13, 4);

INSERT INTO public.regista(
	reg_data, reg_escol, reg_morada, reg_motiv, reg_civil, reg_empreg, eve_id, uti_id)
	VALUES ('2021-12-02', 'Ensino Secundário', 'Cascais', 'Gosto de ajudar a comunidade por não?', null, 'Desempregado', 15, 5);
